"""
Output Adapter: Prompt Builder
Implementazione concreta per costruzione prompt
"""
import textwrap
...
class PromptBuilderAdapter(IPromptBuilder):
    ...
    def build_generate_prompt(
        ...
        """Costruisce il prompt per la generazione di testo"""
